...
const About = () => {
  ...
  return (
    <div
      id="about"
      ref={aboutRef}
      className={`py-16 ${inView ? "about-transition" : "about-hidden"}`}
    >
      {/* Title: About Me */}
      ...
      <div className="flex flex-col lg:flex-row items-center container mx-auto px-6 gap-12 lg:gap-16">
        ...
        <div className="flex-1 space-y-6 py-5 mb-3 text-justify">
          <p className="text-lg text-gray-400 leading-relaxed">
            Hello! {`I'm`} Lutfur Rahman Siddiquee, a passionate software
            developer. I develop web applications, mobile applications, and
            desktop applications. My core skill is based on JavaScript, and I
            love to do most of the things using JavaScript. I love to make the
            web more open to the world. I have graduated with a {`bachelor's`}{" "}
            degree in Computer Science Engineering from Premier University,
            Chittagong, Bangladesh, in 2024. I am available for any kind of job
